...
<div class="layout-contenedor">
    ...
    <div class="formularios-lateral">
        <div class="form-card">
            <?php include 'formulario_registro.php'; ?> <!-- Registrar Nuevo Producto -->
        </div>
        <div class="form-card">
            <?php include 'formulario.php'; ?> <!-- Registrar Movimiento -->
        </div>
    </div>
...
<a href="../pages_administrador/index.php" class="btn-success">Volver al inicio</a>
